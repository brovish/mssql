...
BEGIN
	...
	DECLARE @adhoc_text varchar(max) =
	'SELECT charge_no, member_no, provider_no, category_no, charge_dt, charge_amt, statement_no, charge_code, CHECKSUM(*), NEWID(), POWER(2, 10) FROM dbo.charge WHERE charge_no = '
