...
-- Just to make sure that we're at 7 NC / 1 CL index for FIS
...
-- I use a copy of FIS in my table /index size comparison demo... 
-- You might not want to create this until you get to that script!
-- Copying FIS will take about 20GB space and a bunch of time. 
