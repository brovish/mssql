-- Demo script for Analyzing Nonclustered indexes.

-- If you are unsure of how to setup AdventureWorksDW2012,
-- and have access to Pluralsight, please see Joe Sack's 
-- course 'SQL Server: Transact-SQL Basic Data Retrieval'

-- You can get Microsoft Sample Databases here: https://github.com/Microsoft/sql-server-samples/releases/tag/adventureworks
-- You can use this same script with any of the DW versions of AdventureWorks
...
-- If you're running with DW2016 - the 7 NCs
-- aren't pre-created
...
EXEC sp_SQLskills_helpindex N'FactInternetSales';
EXEC sp_SQLskills_helpindex N'FactInternetSales2';
GO
...
--SO12345 7 chars 2 bytes per char 14 varchar var-block 2 / 2
--18
...
EXEC sp_help N'FactInternetSales';	-- int
EXEC sp_help N'FactInternetSales2';	-- vc20
GO
