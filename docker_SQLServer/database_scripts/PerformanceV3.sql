...
ALTER DATABASE PerformanceV3 SET QUERY_STORE = ON (OPERATION_MODE = READ_WRITE, DATA_FLUSH_INTERVAL_SECONDS = 300, INTERVAL_LENGTH_MINUTES = 1, MAX_STORAGE_SIZE_MB = 20, MAX_PLANS_PER_QUERY = 10);
GO  